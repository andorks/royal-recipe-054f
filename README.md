...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/royal-recipe-054f
```

A live public deployment of this template is available at [https://royal-recipe-054f.templates.workers.dev](https://royal-recipe-054f.templates.workers.dev)
